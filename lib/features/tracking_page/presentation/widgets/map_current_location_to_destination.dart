...
class MapCurrentLocationToDestinationArgs {
  MapCurrentLocationToDestinationArgs({
...
class MapCurrentLocationToDestination extends StatefulWidget {
  const MapCurrentLocationToDestination({
    Key? key,
    required this.args,
  }) : super(key: key);

  final MapCurrentLocationToDestinationArgs args;

  @override
  State<MapCurrentLocationToDestination> createState() =>
      _MapCurrentLocationToDestinationState();
}

class _MapCurrentLocationToDestinationState
    extends State<MapCurrentLocationToDestination> {
  ...
  @override
  void didUpdateWidget(MapCurrentLocationToDestination oldWidget) {
